   ...
   <div className="text-base py-[3%] ">
      ...
      <div className="mb-xl ">
        ...
        <p className="mb-xs text-xl">
          ...
          predictive indicators, engagement indicators, recommendations, EC
          Scores, Alignment Scores, Alignment Status, Alignment Board rankings,
          workflow suggestions, and other informational outputs generated by the
          Platform.
        </p>
        <p className="mb-xs text-xl">
      ...
      <div className="mb-xl ">
        ...
        <p className="mb-xs text-xl">
          ...
          act as an agent or representative, or participate in employment
          contracts or commercial arrangements between Users. All hiring
          decisions are solely the responsibility of the Users involved.
        </p>
        <p className="mb-xs text-xl">
          Connect EC may generate assessments, reports, predictive indicators,
          engagement signals, recommendations, scheduling indicators, EC Scores,
          Alignment Scores, Alignment Status, Alignment Board rankings, and
          other informational outputs designed to support hiring visibility,
      ...
      <div className="mb-xl ">
        <h2 className="font-semibold text-base mb-sm">
          8. EC Scores, Alignment Scores, Status, and Recognition
        </h2>
        <p className="mb-xs text-xl">
          The Platform may generate EC Scores, Alignment Scores, Alignment
          Status, Alignment Board rankings, participation indicators,
          recognition features, and other alignment-related outputs based on
          user participation, engagement, responsiveness, decision-making, and
          alignment-related activities.
        </p>
        <p className="mb-xs text-xl">
          Such scores, status indicators, rankings, recognitions, and
          informational outputs are indicative only and do not create any legal
          rights, obligations, employment rights, contractual rights, or
          entitlements.
        </p>
      </div>
      ...
      <div className="mb-xl ">
        ...
        <p className="mb-xs text-xl">
          ...
          predictive indicators, engagement signals, recommendations, EC Scores,
          Alignment Scores, Alignment Status, Alignment Board rankings, workflow
          suggestions, and other informational outputs.{" "}
        </p>
        <p className="mb-xs text-xl">
      ...
      <div className="mb-xl ">
        ...
        <p className="mb-xs text-xl">
          ...
          predictive indicators, assessment outputs, engagement signals, EC
          Scores, Alignment Scores, Alignment Status, Alignment Board rankings,
          user-generated content, service interruptions, or any indirect,
      ...
      <div className="mb-xl ">
        ...
        <p className="mb-xs text-xl">
          ...
          workflows, user interfaces, text, graphics, icons, status indicators,
          scores, rankings, and visual elements, are the exclusive property of
          <span className="font-bold">PRIMETHIC</span>
           or its licensors and are protected under the <span className="font-bold">Copyright Act, 1957,</span>  trademark laws, and other applicable intellectual property laws.
         
        </p>
        <p className="mb-xs text-xl">
          The platform name Connect EC, together with associated EC Score systems, Alignment Score systems, Alignment Status identifiers, Alignment Board systems and identifiers, and related proprietary marks, names, symbols, and identifiers, are owned by PRIMETHIC and protected under applicable intellectual property laws.
        </p>
        <p className="mb-xs text-xl">
          The Connect EC alignment architecture, hiring workflows, timer-driven action framework, assessment structures, EC Score systems, Alignment Score systems, Alignment Status systems, Alignment Board systems, reports, and related implementations, including their documented structure, sequencing, scoring logic, timer mechanisms, and expressive implementations, are protected under applicable copyright, trademark, trade secret, and other intellectual property laws.
        </p>
        <p className="mb-xs text-xl">
