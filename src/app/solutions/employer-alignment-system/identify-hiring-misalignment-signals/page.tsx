...
export const metadata = {
  title: "Identify Hiring Misalignment and Fix Declines | Connect EC",
  description:
    ...
    <section className="relative">
      <div className="pt-[10%] md:pt-0">
        <div className="relative">
          <section className="relative mt-[5%] md:mt-0 flex items-center justify-center py-[10%] md:py-[5%] px-[5%] md:px-[7%] bg-transparent">
            ...
            />
            <HeroSection
              title={easyNavigator.title}
              description={easyNavigator.description}
              subTitle={easyNavigator.subTitle}
            />
          </section>
        </div>
        <div className="bg-[#F2F8FF]">
          <section className="relative py-[10%] md:py-[5%] px-[5%] md:px-[7%] bg-transparent">
            <FeedbackChallenge data={easyNavigator.feedbackChallengeData} />
          </section>
        </div>
      </div>
      ...
      <div className="py-[5%] md:py-0 bg-[#F2F8FF]">
        <section className="relative py-[5%] px-[5%]">
          <FeedbackAlignment data={easyNavigator.feedbackAlignmentData} />
          <section className="relative py-[3%]">
            <SolutionBannerSection data={easyNavigator.bannerData} />
          </section>
        </section>
      </div>
      ...
      <div className="py-[5%] md:py-0 bg-[#F2F8FF]">
        <section className="relative py-[5%] px-[5%]">
          <FeedbackFlow data={easyNavigator.feedbackFlowData} />
        </section>
      </div>

      <div>
        <section className="relative">
          <ImpactSection data={easyNavigator.impactData} />
        </section>
      </div>
