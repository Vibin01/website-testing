import {
  ...
  recruiterFaqs,
  recruiterContinuityData,
  recruiterAlignmentSystemData,
  recruiterImpactData,
...
export const RecruitersPage = () => {
  return (
    ...
    />
                   ...
                   <div className="bg-[#F2F8FF]">
                     <section className=" relative pb-[5%] px-[5%] md:px-[7%] bg-transparent">
                       <ContinuityBreaksSection data={recruiterContinuityData} />
                     </section>
                   </div>
           
                   <div className="bg-[#F2F8FF]">
                     <section className="relative  py-[5%] px-[5%]">
                       <AlignmentSystemSection data={recruiterAlignmentSystemData} />
                     </section>
                   </div>
                   <div className="">
                     <section className="relative">
                       <ImpactSection data={recruiterImpactData} />
                     </section>
                   </div>
