...
export default function FlowCards() {
  ...
  return (
    <div className="w-full overflow-hidden md:overflow-visible px-[5%]">
      ...
      {/* Mobile Marquee */}
      <div className="flex w-max animate-marquee gap-lg">
        {marqueeCards.map((card, index) => (
          ...
          >
            {/* Icon Box */}
            <div className="absolute left-[4%] top-1/2 flex size-[40px] md:size-iconsize-xl -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-sm bg-[#0668E1] p-[1.5%] sm:rounded-[8px]">
              <img
                src={card.icon}
                alt={`${card.title} icon`}
