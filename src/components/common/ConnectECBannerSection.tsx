  ...
  return (
    <section className="relative  bg-[#FFFFFF1A] pt-10 lg:pt-0">
      <div className=" mx-auto px-[1%] md:px-[3%] ">
        <div className="bg-[#FFFFFF33] md:bg-[#FFFFFF1A] rounded-md md:rounded-[30px] lg:rounded-[40px] shadow-mobile-small md:shadow-web-small   p-4 md:p-6 xl:p-10  text-center relative">
          <div className=" absolute  -top-3 md:-top-3 lg:-top-6 xl:-top-8 left-1/2 -translate-x-1/2 min-w-[300px]">
            <span className="bg-[#FFFFFF] rounded-[40px]  border  px-14  xl:px-20 py-2 lg:py-4 text-[20px] lg:text-[26px] xl:text-[32px] 2xl:text-[40px] font-extrabold text-[#0668E1] shadow-mobile-small md:shadow-web-small">
              Connect EC
            </span>
          </div>
