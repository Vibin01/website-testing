...
outcomeHighlightData: {
  ...
  description_top:
  "Easy Evaluator transforms evaluation behavior into visible alignment signals that enable timely intervention:"
,
  points: [
    "Clear feedback.",
  ...
  cards: [
    ...
    },
    {
      ...
      description: [
        ...
        "Structured signals enable timely intervention and stable coordination.",
      ],
      points: [
...
outcomeHighlightData: {
  ...
  description_top:
  "Easy Scheduler transforms interview interactions into visible coordination signals that enable timely intervention:"
,
  points: [
    "Organized schedules.",
    "Clear responses.",
